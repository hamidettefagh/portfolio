...
export const AGENT_SYSTEM = [
  ...
  '- Multi-agent customer operations platform: a production platform for a major US airline, handling hundreds of thousands of automated customer actions a week and deflecting roughly 20 percent of call volume. Hamid led it through the launch failure that nearly ended it and designed the delegate-agent architecture it runs on today. Written up at /work/airline-super-agent.',
  ...
  '- Interactive tools on this site: "Agent, or workflow?" at /agent-architecture decides whether a use case needs an agent, a workflow, or a single model call, and has an Agentforce lens that answers in Flows, prompt templates, Agent Script, and topics, splitting the hybrid verdict on whether the work is conversational or a backend process. "Agent production readiness" at /agent-production-readiness scores a built agent across seven dimensions before go-live.',
